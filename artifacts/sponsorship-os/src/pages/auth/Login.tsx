  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="ambient-orb ambient-orb-amber w-[500px] h-[500px] -top-40 -left-20 absolute animate-pulse-glow" />
        <div className="ambient-orb ambient-orb-lime w-[400px] h-[400px] bottom-0 right-0 absolute animate-pulse-glow" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        <div className="glass-card glow-inner p-8 space-y-8">
          <div className="text-center">
            <h1 className="font-editorial text-3xl font-light mb-2">Welcome back</h1>
            <p className="text-sm text-muted-foreground">
              New to Flowra?{" "}
              <Link href="/signup" className="text-primary hover:text-primary/80 transition-colors duration-500">
                Create an account
              </Link>
            </p>
          </div>
